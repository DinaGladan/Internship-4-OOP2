...
namespace CleanArchitectureUsersApp.Application.Features.Users.Commands.ActiveUser
{
    public class ActiveUserCommandHandler
    {
        ...
        public ActiveUserCommandHandler(IUserRepository userRepository, IUserUnitOfWork userUnitOfWork)
        {
            _userRepository = userRepository;
            _userUnitOfWork = userUnitOfWork;
        }

        public async Task<Result<bool>> Handle(ActiveUserCommand command)
        {
